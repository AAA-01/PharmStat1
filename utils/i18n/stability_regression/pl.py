# utils/i18n/stability_regression/pl.py
TRANSLATIONS = {
    "stability_regression": {
        "menu_title": "Regresja stabilności",
        "stability_regression_label": "Regresja dla stabilności",
        "stability_regression_desc": (
            "Analiza regresji dla danych stabilnościowych. Regresja stabilnościowa umożliwia przewidywanie trwałości produktów "
            "na podstawie wyników długoterminowych badań stabilności. Jest to kluczowe w przemyśle farmaceutycznym i spożywczym, "
            "gdzie stabilność produktów ma bezpośredni wpływ na ich bezpieczeństwo i skuteczność."
        ),
